...
const state={user:null,profile:null,activePage:"dashboard",pageHistory:["dashboard"],isNavigatingFromPop:false,projects:[],plots:[],clients:[],sellers:[],agents:[],cases:[],ledgerEntries:[],accountCategories:[],registers:[]};
